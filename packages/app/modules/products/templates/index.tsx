...
const ProductTemplate: React.FC<ProductTemplateProps> = ({ product }) => {
  ...
  return (
    <ProductProvider product={product}>
      <View className="small:flex-row small:items-start web:small:container web:pt-16 small:web:pt-2 relative mt-4 flex flex-col justify-center py-6 px-3">
      ...
      <View className="content-container small:px-8 small:my-32 my-16 px-3">
